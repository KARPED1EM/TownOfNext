...
public sealed class NiceGuesser : RoleBase, IMeetingButton
{
    ...
    public override void OverrideNameAsSeer(PlayerControl seen, ref string nameText, bool isForMeeting = false)
    {
        ...
        {
            nameText = Utils.ColorString(Utils.GetRoleColor(CustomRoles.NiceGuesser), seen.PlayerId.ToString()) + " " + nameText;
        }
    }
    ...
    public override bool OnReceiveMessage(string msg) => GuesserMsg(Player, msg);
