...
public static class Options
{
    ...
    public static void Load()
    {
        ...
        LighterVision = FloatOptionItem.Create(6050383, "LighterVision", new(0f, 5f, 0.25f), 1.25f, TabGroup.Addons, false).SetParent(CustomRoleSpawnChances[CustomRoles.Lighter])
            .SetValueFormat(OptionFormat.Multiplier);
