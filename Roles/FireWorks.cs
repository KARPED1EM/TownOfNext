...
namespace TownOfHost
{
    public static class FireWorks
    {
        ...
        public static void SetupCustomOption()
        {
            ...
            FireWorksCount = IntegerOptionItem.Create(Id + 10, "FireWorksMaxCount", new(1, 5, 1), 3, TabGroup.ImpostorRoles, false).SetParent(Options.CustomRoleSpawnChances[CustomRoles.FireWorks])
